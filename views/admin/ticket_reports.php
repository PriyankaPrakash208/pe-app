										...
										<div class="m-section">
											...
											<div class="m-section__content">
												<table class="table">
													...
													<?php 
														$slno = 1;
														foreach($ticket_info as $tickets_data){ 
													?>
														<tr>
															
															<td><?php echo $slno;?></td>
															<td><a href="javascript:;" onclick="monthly_ticket_report(<?php echo $tickets_data['user_id'];?>,<?php echo $tickets_data['dep_id']?>)"><?php echo $tickets_data['fullname'];?></a></td>					
													</tr>
...
<!--							month picker-->
						<div>
							<form class="m-form m-form--fit m-form--label-align-right" action="./ticket_info_monthly"  method="post" id="datepick_rep_form_Admin">
								<div class="m-portlet__body">
...
<!--											<input type="hidden" class="form-control m-input" name="new_user_id" value="<?php //echo $emps['user_id']?>">-->
											<input id="wrk_user_id" type="hidden"  class="form-control m-input" name="user_id" value="">
											<input id="wrk_dep_id" type="hidden"  class="form-control m-input" name="dep_id" value="">
											<div class="col-lg-6 col-md-9 col-sm-12">
												<div class="input-group date" id="admin_datepick_ticket">
												
													
													<input type="text" class="form-control m-input" name="month_pick_ticket" placeholder="Select Here"/>
