					...
					<div class="m-content" style="padding-top: 0;">
						...
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
								<div class="row">
								<div class="col-md-12">
								<form class="m-form m-form--fit m-form--label-align-right" action="javascript:;"  method="post" id="daily_history_form">
								<div class="m-portlet__body">
...
<!--											<input type="hidden" class="form-control m-input" name="new_user_id" value="<?php //echo $emps['user_id']?>">-->
								...
								<div class="m-portlet__body" id="new-div-daily_history"></div>
								<div class="m-portlet__body" id="new-div-daily_history2"></div>
								</div>
