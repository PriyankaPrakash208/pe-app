...
<html lang="en" >
	...
	<head>
		...
		<!-- end::Body -->
	<body onload="getAllComm(<?php echo $user_id?>)" class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed-mobile m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		<!-- begin:: Page -->
