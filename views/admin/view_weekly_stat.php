...
<!--							month picker-->
						<div>
							<form class="m-form m-form--fit m-form--label-align-right" action="javascript:;"  method="post" id="weekly_status_emp">
								<div class="m-portlet__body">
								
								<!--								test code for search and dropdown-->
									<div class="col-md-4" style="float:left;"> 
										<div class="form-group m-form__group row m-form ">
												<input list="emps" name="emps" type="text" id="emp_input_weekly" placeholder="Select an Employee" class="form-control m-input">
												<datalist id="emps">
											  <?php 
													foreach($emp as $emps){ 
												?>
