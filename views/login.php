...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			HASHROOT | PERFORMANCE EVALUATION PORTAL
		</title>
		...
		<script>
			...
			window.location = './mobile.html'; //for example
			}
		</script>
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="User/login" style="margin-bottom:18px;">
...
<!--						forgotten password-->
						<div class="m-login__forget-password">
							...
							<form class="m-login__form m-form" action="" method="post">
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text" placeholder="Email" name="email2" id="m_email" autocomplete="off">
								</div>
								<div class="m-login__form-action">
