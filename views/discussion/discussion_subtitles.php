...
<body class="m-page--fluid m-header--fixed-mobile m-aside-left--enabled m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
					...
					<div class="m-portlet__foot m-portlet__foot--fit">
						<div class="m-form__actions m-form__actions">
							<div class="row ">
								...
								<div class="col-lg-2">
									<a href="" class="btn btn-success m-btn m-btn--pill" data-toggle="modal" data-target="#m_summernote_modal">Start New Sub-Topic</a>
								</div>
								<div class="col-lg-3">
	...
	<!--	close test-->
		...
		?>
		<script type="text/javascript"> var discussion_subtitle_id = null; </script>
