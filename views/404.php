...
<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url('<?php echo base_url(); ?>assets/media/body_pattern.png'); background-repeat: repeat; background-size: auto;">
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					...
					<div class="m-portlet m-portlet--mobile" style="    background-color: #ffffffd4;    border-bottom: 2px solid #e81212; border-radius: 3px;">
									<div class="m-portlet__head" style="    border-bottom: 1px solid #3b3b3c33;height: 50px; color: #000;">
									...
									<div class="m-portlet__body" style="    padding: 20px;">
										HashRoot PE Portal <br/>Thank you!
									</div>
								</div>
					</div>
				</div>
